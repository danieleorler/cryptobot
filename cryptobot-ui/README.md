...
This is a simple react ui for the cryptobot.
...
in the folder ```cryptobot-ui```

the chart is served at ```http://localhost:3000```

by default the app polls the backend every 30 seconds for new values.
